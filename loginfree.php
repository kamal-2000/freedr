...
$query = "SELECT * FROM `testing` WHERE email='$username' and password='$password'";
...
<div id="login">
	...
	<button class="buttonfourth"><a href="contact.php">Contact</a></button>
	<button class="buttonfifth"><a href="loginmain.php">Logout</a></button>
</div>
