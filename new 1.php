...
Full Name<br> <input type="txt"class="inputbox" name="name" id="fname" required><br><br>
...
State <br><input type"txt" class="inputbox" name="state" id="states"required></br></br>

<input type="submit" value="Sign Up" name="signup" class="button">
</form>

</br></br><a href="index.php" class="login">Already Have a Account</a>
